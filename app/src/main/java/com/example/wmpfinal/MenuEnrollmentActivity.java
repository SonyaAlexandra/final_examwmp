...
public class MenuEnrollmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectSubjectButton.setOnClickListener(v -> {
            startActivity(new Intent(MenuEnrollmentActivity.this, SelectSubjectActivity.class));
        });

        viewSummaryButton.setOnClickListener(v -> {
            startActivity(new Intent(MenuEnrollmentActivity.this, StudentSummaryActivity.class));
        });
    }
}
